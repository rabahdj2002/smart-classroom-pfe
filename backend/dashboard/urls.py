...
urlpatterns = [
    ...
    path('classes/<int:id>/edit/', views.edit_class, name='edit_class'),
    ...
    path('students/specializations/', views.specializations, name='specializations'),
    path('students/specializations/add/', views.add_specialization, name='add_specialization'),
    path('students/specializations/<int:id>/edit/', views.edit_specialization, name='edit_specialization'),
    path('students/specializations/<int:id>/delete/', views.delete_specialization, name='delete_specialization'),
